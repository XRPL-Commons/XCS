...
ALTER TABLE "credential_generations" ADD CONSTRAINT "credential_generations_profile_fk" FOREIGN KEY ("profile_id") REFERENCES "public"."network_profiles"("profile_id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
