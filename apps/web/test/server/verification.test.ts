...
} from '../../server/xcs/types.js'
import { canonicalJson } from '../../server/xcs/serialization.js'
import { StaticTrustPolicy, verifyCredential } from '../../server/xcs/verification.js'
